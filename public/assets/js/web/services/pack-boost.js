...
ready(() => {
    ...
    const resourceTextContainer = document.querySelector("#pack-boost .text_container");
    const resourceImageContainer = document.querySelector("#pack-boost .image_container");
